...
const services = [
  { title: "Dog walks", label: "Alex & Morgan", text: "A neighborhood walk shaped around your dog’s energy, pace, and interests, with time to sniff and explore.", link: "Ask about walks", tone: "coral", image: "/photos/morgan-dog-walk.webp", alt: "Morgan in a red shirt walking a black-and-white dog through the neighborhood." },
  { title: "Drop-in visits", label: "Alex & Morgan • At your home", text: "Food, fresh water, litter boxes, medication, play, and company. Visits follow your pets’ routines, whether you have one animal or a whole household.", link: "Ask about visits", tone: "blue", image: "/photos/alex-cat-feeder.webp", alt: "Alex checking in on a gray cat beside its automatic feeder." },
  { title: "Longer visits", label: "At your home", text: "More time together for pets who benefit from a longer visit. We can include a walk, playtime, meals, or quiet company.", link: "Ask about longer visits", tone: "yellow", image: "/photos/alex-westie.webp", alt: "Alex spending time with a white Westie during a visit." },
  { title: "House sitting", label: "Morgan • At your home", text: "Overnight care in your home, where your pets can stay in familiar surroundings and follow their usual routines.", link: "Ask about house sitting", tone: "blue", image: "/photos/morgan-chihuahua-chair.webp", alt: "Morgan relaxing in a brown chair with a small brown Chihuahua." },
  { title: "Doggy daycare", label: "At Morgan’s home", text: "Daytime care and company at Morgan’s home, with time for activity and rest.", link: "Ask about daycare", tone: "yellow", image: "/photos/alex-bathtub.webp", alt: "Alex sitting beside a black dog in a bathtub." },
