...
const photos = [
  ...
  { src: "/photos/dog-kiss.jpg", alt: "A large tan dog licking Alex on the cheek." },
];
  ...
  return <main>
    ...
    <section className="hero page-shell" id="top">
      ...
      <div className="hero-visual">
        <div className="hero-photo-frame"><Image src={assetPath("/photos/morgan-dogs-couch.png")} alt="Morgan relaxing on a couch with three dogs." fill priority sizes="(max-width: 980px) 92vw, 48vw" /></div>
