  ...
  return <main>
    ...
    <section className="hero page-shell" id="top">
      ...
      <div className="hero-visual">
        <div className="hero-photo-frame"><Image src={assetPath("/photos/hero-apollo.jpg")} alt="Alex standing beside a large fluffy white dog on a sidewalk." fill priority sizes="(max-width: 980px) 92vw, 48vw" /></div>
